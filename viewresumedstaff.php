  ...
  try 
      {
        ...
        #The result is usually
          $stmt = $lvobj->getResumptionViewHOD($dept, $hodid, $cat); 
 ...
 #Dean or Director section
  ...
  elseif ($id == $hro){
    ...
    try 
      {
        #Query to select leave details of the $this staff
          $stmt = $lvobj->getResumptionViewHR($hro);
          $num = $stmt->rowCount();
  ...
  elseif ($id == $rego){
   // echo "REGISTRAR";
    try 
      {
        #Query to select leave details of the $this staff
        $stmt = $lvobj->getResumptionViewReg($rego);
        $num = $stmt->rowCount();
  ...
  elseif ($id == $vco){
    ...
    try 
      {
        #Query to select leave details of the $this staff
        $stmt = $lvobj->getResumptionViewVC($vco);
        $num = $stmt->rowCount();
