         ...
         $schedule = array();
          ...
          while($row = $stmt->fetch(PDO::FETCH_ASSOC))         
                {        
                  ...
                  $scheduleDetails[$i]['daysworked'] = $lvobj->getDaysWorked($daysworked);
                  $scheduleDetails[$i]['daysentitled'] = $lvobj->getEntitleDays($row['staffid']);
                  $scheduleDetails[$i]['permissibledays'] = $lvobj->annualPermissibleDays($row['staffid'], $currentsession, $leavetype);
                  $scheduleDetails[$i]['leavebonus'] = $lbonus;


                  //array_push($scheduleDetails[$i], $lvobj->getDaysWorked($daysworked), $lvobj->getEntitleDays($row['staffid']));
                  $i++;
                }//end of while loop
                   echo "<tr>";
